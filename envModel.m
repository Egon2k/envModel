...
param.tractor.wheelbase         = 3.5;                % [m]
param.tractor.hitchLength       = 0.72;             % [m]
param.tractor.psiInit           = 0 * pi/180;
param.tractor.trackWidth        = 2.0;

%% control
radius                          = 15;               %[m]
control.tractor.steeringAngle   = -20 * pi / 180;%-atan(param.tractor.wheelbase/radius);
...
%     if i == 15/sim.dt
%         crabSteerOffset = asin(0.25);
%     end 
%     
%     if i == 20/sim.dt
%         crabSteerOffset = asin(0.5);
%     end 
%     
%     if i == 30/sim.dt
%         crabSteerOffset = -asin(0.5);
